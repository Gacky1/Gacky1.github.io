...
contact.skip.addEventListener("click", ()=>{contact.next_query()});
contact.back.addEventListener("click", ()=>{contact.prev_query()});
document.querySelector(".c-close").addEventListener("click", ()=>{contact.close()});

contact.send.addEventListener("click", function(e){contact.next_query()});
...
contact_form.addEventListener('submit', e => {
  e.preventDefault();
  fetch(scriptURL, { method: 'POST', body: new FormData(contact_form)})
